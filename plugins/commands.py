...
"""
    ...
    buttons = [
        [
            InlineKeyboardButton('🛫 Support Group 🛫', url=f"https://t.me/SLBotsChat"),
            InlineKeyboardButton('Channel 📢', url=f"https://t.me/SLBotOfficial")
            ],[
           ...
           InlineKeyboardButton('GitHup 🤣', url=f"https://github.com/SL-bots")
        ]
    ]
    await m.reply_text(
        text=text,
